...
// Whisper represents a dark communication interface through the AICHAIN
...
// New creates a Whisper client ready to communicate through the AICHAIN P2P network.
