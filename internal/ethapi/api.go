...
// NewPublicEthereumAPI creates a new AICHAIN protocol API.
...
// ProtocolVersion returns the current AICHAIN protocol version this node supports
...
// Sign calculates an AICHAIN ECDSA signature for:
...
//
// https://github.com/AICHAIN-CORE/go-aichain/wiki/Management-APIs#personal_sign
...
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	...
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid AICHAIN signature (V is not 27 or 28)")
	}
...
// PublicBlockChainAPI provides an API to access the AICHAIN blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new AICHAIN blockchain API.
...
func RPCMarshalBlock(b *types.Block, inclTx bool, fullTx bool) (map[string]interface{}, error) {
	...
	fields := map[string]interface{}{
		...
		"nonce":            head.Nonce,
		"sigData":          hexutil.Bytes(head.SigData),
...
//
// https://github.com/AICHAIN-CORE/wiki/wiki/JSON-RPC#eth_sign
...
// PublicDebugAPI is the collection of AICHAIN APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of AICHAIN APIs exposed over the private
// debugging endpoint.
...
// Version returns the current aichain protocol version.
