...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gait.ipc",
			endpoint:    "/data/testnet/gait.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gait.ipc",
			endpoint:    "/data/testnet/gait.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gait.ipc",
			endpoint:    "/data/testnet/gait.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gait.ipc",
			endpoint:    "/data/testnet/gait.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
