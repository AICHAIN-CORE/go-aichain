...
import (
	...
	ch "github.com/AICHAIN-CORE/go-aichain/swarm/chunk"
	"github.com/AICHAIN-CORE/go-aichain/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/AICHAIN-CORE/go-aichain/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
