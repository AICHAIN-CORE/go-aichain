...
//
// # go test -benchmem -run=none github.com/AICHAIN-CORE/go-aichain/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: github.com/AICHAIN-CORE/go-aichain/swarm/storage/localstore
...
//
// go test -benchmem -run=none github.com/AICHAIN-CORE/go-aichain/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: github.com/AICHAIN-CORE/go-aichain/swarm/storage/localstore
