...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gait.ipc", false, filepath.Join(os.TempDir(), "gait.ipc")},
		{"data", "gait.ipc", false, "data/gait.ipc"},
		{"data", "./gait.ipc", false, "./gait.ipc"},
		{"data", "/gait.ipc", false, "/gait.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gait.ipc", true, `\\.\pipe\gait.ipc`},
		{"data", "gait.ipc", true, `\\.\pipe\gait.ipc`},
		{"data", `\\.\pipe\gait.ipc`, true, `\\.\pipe\gait.ipc`},
	}
