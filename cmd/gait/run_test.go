...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gait-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gait-test" in runGeth.
	reexec.Register("gait-test", func() {
...
// spawns gait with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "gait". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gait-test", args...)
