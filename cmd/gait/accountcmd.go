...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage AICHAIN presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gait wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import AICHAIN presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gait wallet [options] /path/to/my/presale.wallet
...
between aichain nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gait account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gait account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another aichain instance,
