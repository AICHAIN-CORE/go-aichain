...
// newCppEthereumGenesisSpec converts a go-aichain genesis block into a Parity specific
// chain specification format.
func newCppEthereumGenesisSpec(network string, genesis *core.Genesis) (*cppEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-aichain and cpp-aichain
