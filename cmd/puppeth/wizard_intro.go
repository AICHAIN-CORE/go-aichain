...
// setting up a new or managing an existing AICHAIN private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your AICHAIN private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new AICHAIN network down to  |")
	...
	log.Info("Administering AICHAIN network", "name", w.network)
