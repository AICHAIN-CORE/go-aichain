...
type wizard struct {
	...
	services map[string][]string   // AICHAIN services known to be running on servers
...
// converts it to an AICHAIN address. If an empty line is entered, the default
// value is returned.
