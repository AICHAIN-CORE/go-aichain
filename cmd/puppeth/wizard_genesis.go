...
// importGenesis imports a Gait genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and Gait
		...
		// Export the genesis spec used by Aleth (formerly C++ AICHAIN)
