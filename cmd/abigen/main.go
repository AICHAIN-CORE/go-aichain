...
import (
	...
	"github.com/AICHAIN-CORE/go-aichain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the AICHAIN contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the AICHAIN contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the AICHAIN contract Solidity source to build and bind")
