...
func TestValidateConfig(t *testing.T) {
	for _, c := range []struct {
		...
		{
			cfg: &api.Config{EnsAPIs: []string{
				"314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gait.ipc",
			}},
		},
		{
			cfg: &api.Config{EnsAPIs: []string{
		...
		{
			cfg: &api.Config{EnsAPIs: []string{
				"test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gait.ipc",
			}},
		},
		{
			cfg: &api.Config{EnsAPIs: []string{
		...
		},
		{
			...
			err: "invalid format [tld:][contract-addr@]url for ENS API endpoint configuration \"@/data/testnet/gait.ipc\": missing contract address",
		},
	} {
