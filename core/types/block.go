...
// Header represents a block header in the AICHAIN blockchain.
type Header struct {
...
// Block represents an entire block in the AICHAIN blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the AICHAIN RLP block format.
