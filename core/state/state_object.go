...
// stateObject represents an AICHAIN account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of aichain address of the account
	data     Account
	db       *StateDB
...
// Account is the AICHAIN consensus representation of accounts.
