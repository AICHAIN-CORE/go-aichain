...
// StateDBs within the aichain protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/AICHAIN-CORE/go-aichain/pull/16485#issuecomment-380438527),
