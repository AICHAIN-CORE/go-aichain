...
// Package p2p implements the AICHAIN p2p network protocols.
package p2p
...
import (
	...
	"github.com/AICHAIN-CORE/go-aichain/p2p/enr"
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "aichain discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "aichain p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // AICHAIN Node Record
