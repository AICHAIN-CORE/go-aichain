...
// rules of the stock AICHAIN ethash engine.
...
func (ethash *Ethash) verifyHeader(chain consensus.ChainReader, header, parent *types.Header, uncle bool, seal bool) error {
	...
	// already checked in the aiconsensus engine
	...
	//verify outside, no need to check here
...
func (ethash *Ethash) CalcDifficulty(chain consensus.ChainReader, time uint64, parent *types.Header) *big.Int {
	return big.NewInt(-1)
	//set outside, not need to set it
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/AICHAIN-CORE/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/AICHAIN-CORE/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
...
func (ethash *Ethash) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	...
	target := new(big.Int).Div(maxUint256, ethash.defaultPowDifficulty)
...
func (ethash *Ethash) Prepare(chain consensus.ChainReader, header *types.Header) error {
	...
	//set outside, not need to set here.
...
func (ethash *Ethash) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
	...
	//rewards is added in aiconconsus
