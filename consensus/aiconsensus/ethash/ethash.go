...
var (
	...
	sharedEthash = New(Config{ModeNormal}, big.NewInt(10000))
...
type Ethash struct {
	...
	defaultPowDifficulty *big.Int //default difficulty to mine
...
func New(config Config, diff *big.Int) *Ethash {
	return &Ethash{
		config:               config,
		update:               make(chan struct{}),
		hashrate:             metrics.NewMeter(),
		defaultPowDifficulty: diff,
	}
}
...
func NewTester() *Ethash {
	return New(Config{PowMode: ModeTest}, big.NewInt(10000))
}
