...
import (
	...
	"github.com/AICHAIN-CORE/go-aichain/internal/jsre"
	"github.com/AICHAIN-CORE/go-aichain/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute AICHAIN requests through
...
// Welcome show summary of current Gait instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gait metadata
	fmt.Fprintf(c.printer, "Welcome to the Gait JavaScript console!\n\n")
	c.jsre.Run(`
