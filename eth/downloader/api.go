...
// Syncing provides information when this nodes starts synchronising with the AICHAIN network and when it's finished.
...
type SyncingResult struct {
	...
	Status  aichain.SyncProgress `json:"status"`
}
