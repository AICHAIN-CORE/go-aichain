...
// PeerInfo represents a short summary of the AICHAIN sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // AICHAIN protocol version negotiated
