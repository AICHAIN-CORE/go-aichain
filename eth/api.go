...
// PublicEthereumAPI provides an API to access AICHAIN full node-related
// information.
type PublicEthereumAPI struct {
	e *AICHAIN
}

// NewPublicEthereumAPI creates a new AICHAIN protocol API for full nodes.
func NewPublicEthereumAPI(e *AICHAIN) *PublicEthereumAPI {
...
func NewPublicMinerAPI(e *AICHAIN) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *AICHAIN) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of AICHAIN full node-related APIs
...
// admin methods of the AICHAIN service.
func NewPrivateAdminAPI(eth *AICHAIN) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of AICHAIN full node APIs exposed
...
// related public debug methods of the AICHAIN service.
func NewPublicDebugAPI(eth *AICHAIN) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of AICHAIN full node APIs exposed over
...
// private debug methods of the AICHAIN service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *AICHAIN) *PrivateDebugAPI {
