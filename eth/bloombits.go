...
const (
	// bloomServiceThreads is the number of goroutines used globally by an AICHAIN
...
func (eth *AICHAIN) startBloomHandlers(sectionSize uint64) {
...
// for the AICHAIN header bloom filters, permitting blazing fast filtering.
