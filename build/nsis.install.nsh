Name "gait ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/AICHAIN-CORE/go-aichain/issues"
!define UPDATEURL "https://github.com/AICHAIN-CORE/go-aichain/releases"
!define ABOUTURL "https://github.com/AICHAIN-CORE/go-aichain#aichain-go"
...
# Install gait binary
Section "Gait" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gait}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gait.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gait.exe" "attach" "" ""
  ...
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gait.ipc"
