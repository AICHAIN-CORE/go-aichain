...
# 1. install gait for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gait
# 5. create gait, attach and uninstall start menu entries
...
!define GROUPNAME "AICHAIN"
!define APPNAME "Gait"
!define DESCRIPTION "Official Go implementation of the AICHAIN protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gait is installed global
