...
//
// Detailed usage document and tutorial available on the go-aichain Wiki page:
// https://github.com/AICHAIN-CORE/go-aichain/wiki/Native-DApps:-Go-bindings-to-AICHAIN-contracts
package bind
