...
// Package accounts implements high level AICHAIN account management.
package accounts
...
// Account represents an AICHAIN account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // AICHAIN account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain aichain.ChainStateReader)
